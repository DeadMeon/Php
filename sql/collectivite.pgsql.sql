-- création de la table collectivité(col_code, col_nom, col_population, col_superficie, col_region)
...
-- création de la table ville(vil_num, vil_nom, vil_population, vil_statut, dep_code)
